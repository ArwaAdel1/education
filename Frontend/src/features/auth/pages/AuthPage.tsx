...
import { z } from "zod";
import {
  GraduationCap, User, Mail, Phone, Lock, Eye, EyeOff, Languages,
  type LucideIcon,
} from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="relative flex flex-1 items-center justify-center px-5 py-10">
        <button
          type="button"
          onClick={() => dispatch(changeLanguage(language === "ar" ? "en" : "ar"))}
          className="absolute right-6 top-5 flex items-center gap-1.5 rounded-full border border-border bg-surface px-3.5 py-1.5 text-xs font-bold text-primary transition hover:bg-background"
        >
          <Languages size={15} />
